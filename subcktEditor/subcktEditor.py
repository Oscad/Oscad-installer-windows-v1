...
def importEditor(e=None):
  ...
  for i in list:
    if shutil.copy2(OSCAD_HOME+"/subcktLibrary/"+subckt.Name+i,"."):
      tkMessageBox.showerror("Export Failed","Unable to export subcircuit file "+subckt.Name)
    else:
      pass
  #if shutil.copy2(OSCAD_HOME+"/subcktLibrary/"+subckt.Name+".*","."):
...
def exportEditor(e=None):
  ...
  list=[".bak",".cir",".cir.out",".cir.ckt",".pro",".sub",".sch"]
  #if shutil.copy2(subckt.Name+".sch",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".bak",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".sub",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".pro",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".cir.ckt",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".cir.out",OSCAD_HOME+"/subcktLibrary/") && shutil.copy2(subckt.Name+".cir",OSCAD_HOME+"/subcktLibrary/"):
  for i in list: 
    if shutil.copy2(subckt.Name+i,OSCAD_HOME+"/subcktLibrary/"):
      tkMessageBox.showerror("Export Failed","Unable to export subcircuit file "+subckt.Name)
    else:
      pass
